<template>
  <div class="main grid-container fluid">
    <breadcrumbs v-bind="{'header': 'Фильтрация запросов по конкурентам', 'crumbs': [{'text': 'Мои проекты', 'link': ''}, {'text': project.domain, 'link': '#/project/' + project.projectId}]}"></breadcrumbs>
